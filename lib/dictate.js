(function(window){
	...
	var Dictate = function(cfg) {
		...
		this.init = function() {
			...
			try {
				_getUserMedia = MediaDevices.getUserMedia || navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia;
			...
			if (_getUserMedia) {
				...
				_getUserMedia(audioSourceConstraints, startUserMedia, function(e) {
